...
**Example:** A direct-to-consumer skincare brand cannot understand why repeat purchase falls off after the first bottle. A week-long diary study plus six home visits reveals that the bottle is being stored in a bathroom where the label fades, and the brand becomes literally invisible at reorder time. The fix is a label material change. The dashboard never could have surfaced that.
