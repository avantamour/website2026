...
description: "A WhatsApp diary study is a qualitative research method in which participants record their experiences in real time over five to ten days, sent via voice notes, photos, and short videos on WhatsApp."
category: "method"
...
**A WhatsApp diary study is** a qualitative research method in which participants record their own experiences in real time over five to ten days, sending the researcher voice notes, photos, screenshots, and short videos on WhatsApp. It is the practical adaptation of the academic diary-study tradition for a market — India — where WhatsApp is already the default communication tool.
...
**Example:** A skincare brand runs a ten-day diary study to understand why first-time customers do not reorder. The diary reveals that the unboxing experience is rated highly, but the bottle disappears into a crowded bathroom shelf by the second week and is forgotten. The fix is operational, not creative.
